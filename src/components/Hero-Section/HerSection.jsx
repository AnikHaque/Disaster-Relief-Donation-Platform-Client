      ...
      <div className="md:flex p-5 mb-24 justify-between items-center ">
        <div className="px-3 md:px-0">
          ...
          <div className="flex ">
            ...
            <button className="flex border font-medium border-[#2A9D8F] mt-2 md:px-4 py-[8px] text-[#515151] rounded p-1 items-center justify-center">
              <BsFillPlayFill className="md:mr-2 text-xl text-[#2A9D8F]"></BsFillPlayFill>{" "}
              Explore Our Vision
            </button>
          </div>
        </div>
        <div className="max-w-lg">
          <img src={hero} alt="Rectangle-137" border="0" />
        </div>
      </div>
    </div>
  );
